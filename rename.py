...
folder_path = r"C:\Users\User\OneDrive\Desktop\Github desktop\deep_learning_acute_illness_pri\data\parsed\rug_sick"
...
for index, filename in enumerate(files, start=1):
    ...
    # new_filename = f"ai-{index}-sick{file_extension}"
